...
houseWalls.geometry.setAttribute(
  "uv2",
  new THREE.Float32BufferAttribute(houseWalls.geometry.attributes.uv.array, 2)
);
houseWalls.position.y = dimensions.height / 2;
...
houseRoof.position.set(0, dimensions.height + 1, 0);
...
door.position.z = dimensions.length / 2 + 0.01;
house.add(door);
...
const moonLightFolder = gui.addFolder("Moon Light Controls");
...
// const axesHelper = new THREE.AxesHelper(112);
